  ...
  return (
    ...
    className='bg-primeira grid md:flex px-10 justify-center items-center min-h-[640px]'>
        ...
        <div className="grid md:flex md:flex-col md:justify-center mt-0 md:p-10 w-[100%] order-1">
            ...
            <p className='mt-10 mb-5 text-2xl md:text-3xl text-white w-[100%] font-sen'>To schedule a cleaning service or request a quote, fill out the form. </p>
            <p className='mt-10 mb-5 text-2xl md:text-3xl text-white w-[100%] font-sen'>Share with us the details of the desired service, whether its for residential, commercial cleaning, or for a special event. </p>
            <p className='mt-10 mb-5 text-2xl md:text-3xl text-white w-[100%] font-sen'>We are ready to meet your needs and ensure the cleanliness and comfort you deserve.</p>
